...
export default function DescripcaoCTAVantagem() {
  return (
    ...
    <div className="container space-2">
      <div className="row">
        <div className="col-lg-4 mb-7 mb-lg-0">
          <div className="mb-4">
            <h2 className="h1">Agendamento Digital</h2>

            <img className="img-fluid mr-3" src="/assets/svg/icons/icon-1.svg" alt="Logo" width="40" height="40"/>
            <img className="img-fluid mr-3" src="/assets/svg/icons/icon-23.svg" alt="Logo" width="40" height="40"/>
            <img className="img-fluid mr-3" src="/assets/svg/icons/icon-67.svg" alt="Logo" width="40" height="40"/>
          </div>
      ...
      <div className="mt-lg-n11 mb-7 mb-lg-0">
        ...
        <figure className="ie-device-and-mobile">
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 2058.5 1182.2" xmlSpace="preserve">
            ...
            <g>
              ...
              <g>
                ...
                <g clip-path="url(#devices1ID_3)">
                  <image id="SVGDevices1LaptopImg" width="1618" height="1010" xlinkHref="/assets/img/1618x1010/estudar-a-distancia.png"  transform="matrix(0.5622 0 0 0.5622 998.0432 45.2877)"></image>
                </g>
                <g>
      ...
      <div className="row justify-content-lg-end">
        <div className="col-lg-7 mt-lg-n11">
          <h2 className="h1 mb-4">Prova On-line</h2>
          <p>Faça a Prova On-line pelo computador, celular ou tablet. Você ainda pode conquistar uma bolsa de até 50%, de acordo com a nota!</p>
        </div>
      </div>
    </div>
